    ...
    return (
        <div className="max-w-[1150px] bg-[#1a1a1a] rounded-full overflow-hidden border-2 border-[#333333] p-1.5 px-5 pr-8 flex items-center">
            ...
            <input
                ...
                className="bg-[#1a1a1a] text-white border-none lg:w-full
                focus:ring-0 outline-none placeholder-[#fafafa] text-xs"
                placeholder="검색..."
            />
            <div className="flex items-center divide-dotted divide-x-2 divide-[#333]">
                <div className="flex space-x-2 pr-5">
                    <button className="tag">팝</button>                    
                    <button className="tag">Kpop</button>
                </div>
